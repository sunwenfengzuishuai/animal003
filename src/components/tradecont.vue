    ...
    <div class="body-containner">
            ...
            <div class="ill-show-cont">
              ...
              <div class="tablecontent-cont scorllbar" v-if="productInfor!=undefined">
                <table class="tablecontent" cellspacing="0" cellpadding="0">
                  <tr v-for="(pro_item, index) in productInfor" @click="trclick(pro_item)"
                      @dblclick="gotoilldetails(pro_item)">
                    <td>{{index+1}}</td>
      ...
      <div class="body-right-cont">
        ...
        <div class="body-right-item2">
          ...
          <div class="line-chart-cont">
            <div class="left">
              <traderightmap3></traderightmap3>
            </div>
            <div class="right">34134124324右边</div>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  import tradeworldmap from './map/tradeworldmap'
  ...
  import ProSpecialWorldMap from './map/prospecialworldmap.vue'
  ...
  export default {
    ...
    watch:{
      animaltype(oldval,newval){
        this.queryTradeCountryPro()
      },
      elementid(oldval,newval){
        this.queryTradeData()
      },
      // defaultoiefid(oldval,newval){
      //   alert(newval)
      //   this.queryAnimalYearCount()
      // }
    },
    methods:{
      ...
      async queryTradeData(){//点击搜索按钮的回掉函数
        ...
        // 如果为加工产品则调用查询加工产品的接口
          ...
          var data = await requestTrade.queryTrade(this.propageNo, this.propageSize, this.elementid ,this.proanimalvalue[0], this.proanimalvalue[1], this.countryvalue[0], this.countryvalue[1], this.proyearvalue);
          //console.log(this.propageNo, this.propageSize, this.elementid, this.animalvalue[0], this.animalvalue[1], this.countryvalue[0], this.countryvalue[1], this.proyearvalue)
          this.productInfor = data.list;
          this.prototalCount = data.totalCount;
        }
      ...
      async queryTradeCountryPro(){//查询贸易生产.列表
        ...
        // 如果为加工产品则调用查询加工产品的接口
          ...
          var data = await requestTrade.queryTradeCountryPro1(this.leftdownpageNo, this.leftdownpageSize,  this.animalvalue[0], this.animalvalue[1], this.countryvalue[0], this.countryvalue[1], this.leftdownyearvalue);
          this.trades = data.list
          this.leftdowntotalCount = data.totalCount;
        }
      },
