				    ...
				    series: [
				        {
				            ...
				            data: allcoordinates.illcoordinates.outbreakfrist,
				            activeOpacity: 1,
				            label: {
				                normal: {
				                    formatter: '{b}',
...

				        {
				            ...
				            type: 'scatter',
				            coordinateSystem: 'geo',
				            data: allcoordinates.coordinates.outbreak,
				            activeOpacity: 1,
				            label: {
				                normal: {
				                    formatter: '{b}',
				        ...
				        },
				        {
				            ...
				            type: 'scatter',
				            coordinateSystem: 'geo',
				            data: allcoordinates.coordinates.outbreakend,
				            activeOpacity: 1,
				            label: {
				                normal: {
				                    formatter: '{b}',
				        ...
				        },
				        {
				            ...
				            type: 'scatter',
				            coordinateSystem: 'geo',
				            data: allcoordinates.coordinates.outbreakfrist,
				            activeOpacity: 1,
				            label: {
				                normal: {
				                    formatter: '{b}',
